...
- [Forge-to-Cosmic Compile Contract](cosmic-compile-contract.md) — semantic library inputs, SIA32 user-image output, address/entry requirements, and the boundary between Forge emission and Lighting execution.
