    ...
    pub const fn encode(self) -> u16 {
        ...
        match self {
            ...
            Self::ReadSystem {
                rd,
                system_register,
            } => p::sread(rd, system_register),
            Self::WriteSystem {
                system_register,
                rs,
            } => p::swrite(system_register, rs),
...
mod tests {
    ...
    fn source_contract_maps_only_to_normative_encodings() {
        ...
        assert_eq!(
            Sia32PrivilegedOp::ReadSystem {
                rd: 3,
                system_register: SYSREG_CAUSE
            }
            .encode(),
            0xf032
        );
        assert_eq!(
            Sia32PrivilegedOp::WriteSystem {
                system_register: SYSREG_VMCTX,
                rs: 3
            }
            .encode(),
            0xf135
