...
#[test]
fn executes_choose_as_native_aarch64_machine_code() {
    ...
    let choose: extern "C" fn(u64) -> u64 = unsafe { std::mem::transmute(executable.ptr) };

    assert_eq!(choose(5), 2);
    assert_eq!(choose(10), 2);
    assert_eq!(choose(11), 1);
    assert_eq!(choose(20), 1);
}
