...
fn rv64_elf_launcher(function: &[u8], argument: u16) -> Vec<u8> {
    ...
    let wrapper = [
        encode_addi(10, 0, argument as i16), // a0 = argument
        encode_jal(1, 12),                   // ra = pc + 4; jump to function at +16
        encode_addi(17, 0, 93),              // a7 = Linux exit syscall
        0x0000_0073,                          // ecall; exit(a0)
    ];
